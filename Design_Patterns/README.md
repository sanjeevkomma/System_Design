...
| :---| :--- | :--- |:--- |:--- | 
|1 | Factory Pattern(Simplified version of Factory Method)| creates objects without exposing the instantiation logic to the client and refers to the newly created object through a common interface  |  |  |
